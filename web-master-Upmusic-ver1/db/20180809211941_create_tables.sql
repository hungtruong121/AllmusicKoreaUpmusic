...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `name` enum('ROLE_ADMIN','ROLE_FAMILY','ROLE_ARTIST','ROLE_GUIDE','ROLE_MEMBER') NOT NULL DEFAULT 'MEMBER',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
INSERT INTO `role`(id, name) VALUES (1,'ROLE_ADMIN'),(6,'ROLE_FAMILY'),(7,'ROLE_ARTIST'),(8,'ROLE_GUIDE'),(9,'ROLE_MEMBER');
--
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `upm_point` DECIMAL(13,3)  NOT NULL DEFAULT '0.000',
  `funding_point` DECIMAL(13,3) NOT NULL DEFAULT '0.000',
  `hyc` smallint unsigned NOT NULL DEFAULT '0',
  `copyright_membership` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `point_transaction` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int(10) unsigned NOT NULL,
  `transaction_type` enum('LISTEN', UPLOAD', 'SHARE', 'EVENT', 'HYC', 'FUNDING'),
  `transaction_type_id` int(10) unsigned DEFAULT NULL,
  `upm_point` float(12,3) NOT NULL DEFAULT '0.000',
  `funding_point` float(12,3) NOT NULL DEFAULT '0.000',
  `created_at` datetime,
  `updated_at` datetime,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
--
-- Table structure for table `point_reward_condition`
--
CREATE TABLE IF NOT EXISTS `point_reward_condition` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `listen_first_step_point` float(4,2) unsigned NOT NULL DEFAULT '0.00',
  `listen_first_step_limit` smallint unsigned NOT NULL DEFAULT '1',
  `listen_second_step_point` float(4,2) unsigned NOT NULL DEFAULT '0.00',
  `listen_second_step_limit` smallint unsigned NOT NULL DEFAULT '1',
  `listen_third_step_point` float(4,2) unsigned NOT NULL DEFAULT '0.00',
  `listen_third_step_limit` smallint unsigned NOT NULL DEFAULT '0',
  `listen_artist_point` float(4,2) unsigned NOT NULL DEFAULT '0.00',
  `upload_point` smallint unsigned NOT NULL DEFAULT '0',
  `share_point` smallint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `music_album` (
  ...
  `album_local` smallint unsigned NOT NULL DEFAULT '1',
  `album_type` smallint unsigned NOT NULL DEFAULT '1',
  `genre_id` smallint unsigned NOT NULL DEFAULT '1',
  `hit_cnt` int unsigned NOT NULL DEFAULT '0',
  `heart_cnt` smallint unsigned NOT NULL DEFAULT '0',
  `accepted_track_cnt` smallint unsigned NOT NULL DEFAULT '0',
  `created_at` datetime,
  `updated_at` datetime,
  PRIMARY KEY (`id`),
  KEY `member_id` (`member_id`),
...
CREATE TABLE IF NOT EXISTS `music_track` (
  ...
  `rental_fee` mediumint unsigned NOT NULL DEFAULT '0',
  `price` mediumint unsigned NOT NULL DEFAULT '0',
  `sort_no` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `title_track` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `music_track_theme`
--
CREATE TABLE IF NOT EXISTS `music_track_theme` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `music_track_id` int(10) unsigned NOT NULL,
  `member_id` int(10) unsigned NOT NULL,
  `created_at` datetime,
  ...
  CONSTRAINT `music_track_theme_ibfk_1` FOREIGN KEY (`music_track_id`) REFERENCES `music_track` (`id`),
  CONSTRAINT `music_track_theme_ibfk_2` FOREIGN KEY (`theme_id`) REFERENCES `theme` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
--
...
--
-- Table structure for table `music_track_rejected_reason`
--
CREATE TABLE IF NOT EXISTS `music_track_rejected_reason` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `music_track_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `music_track_id` (`music_track_id`),
  CONSTRAINT `music_track_rejected_reason_ibfk_1` FOREIGN KEY (`music_track_id`) REFERENCES `music_track` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
------------------------------------------------------------------------------------------------------------------------------ RECOMMENDED TRACK & VIDEO

--
-- Table structure for table `recommended_music_track`
--
CREATE TABLE IF NOT EXISTS `recommended_music_track` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `music_track_id` int(10) unsigned NOT NULL,
  `created_at` datetime,
  PRIMARY KEY (`id`),
  KEY `music_track_id` (`music_track_id`),
  CONSTRAINT `recommended_music_track_ibfk_1` FOREIGN KEY (`music_track_id`) REFERENCES `music_track` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Table structure for table `recommended_video`
--
CREATE TABLE IF NOT EXISTS `recommended_video` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `video_id` int(10) unsigned NOT NULL,
  `created_at` datetime,
  PRIMARY KEY (`id`),
  KEY `video_id` (`video_id`),
  CONSTRAINT `recommended_video_ibfk_1` FOREIGN KEY (`video_id`) REFERENCES `video` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
