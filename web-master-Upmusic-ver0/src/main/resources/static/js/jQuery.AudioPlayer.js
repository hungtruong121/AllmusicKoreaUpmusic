    ...
    var AudioPlayer = {
        options: {
            ...
            template: $('<div id="componentWrapper">' +
                '<audio id="audio-element" style="display: none;"><source></source></audio>' +
                '<div class="player_progress player_barwrap">' +
                '<div class="progress_bg"></div>' +
                '<div class="load_progress"></div>' +
                '<div class="play_progress player_bar mt0"><div class="player_round"></div></div>' +
                '<div class="player_progress_tooltip">' +
                '<p></p>' +
                '</div>' +
                '</div>' +
                '<div class="palyer_btn palyer_btn2 mt10"><ul><li class="player_mediaTime_current">00:00</li>' +
                '<li class="player_mediaTime_total">00:00</li>' +
                '<li class="controls_toggle"><img src="" alt="controls_toggle" /></li>' +
                '<li class="player_volume"><img src="" alt="player_volume" /></li>' + 
                '<li class="player_volume_bar"><div class="player_barwrap sound_barwrap">' +
                '<div class="volume_seekbar">' +
                '<div class="volume_bg"></div>' +
                '<div class="volume_level player_bar"><div class="player_round"></div></div>' +
                '</div>' +
                '</div>' +
                '</li>' +
                '</ul>')
        ...
        init: function(options) {
            ...
            _this.elements.audiosource = _this.options.template.find('source')[0];
            // 播放按钮
            ...
            _this.elements.playButton.find('img').attr('src', _this.options.imagePath + '/player_btn4.png');
        ...
        updateSource: function(o){
            ...
            // 更新音频来源
            _this.elements.audiosource.setAttribute('src', o.source);
