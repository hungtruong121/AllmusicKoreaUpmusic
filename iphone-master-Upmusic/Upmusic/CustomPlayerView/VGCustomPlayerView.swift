...
class VGCustomPlayerView: VGPlayerView {
    ...
    let bottomProgressView : UIProgressView = {
        ...
        progress.tintColor = #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1)
    ...
    override func configurationUI() {
        ...
        self.timeSlider.minimumTrackTintColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
        ...
        self.closeButton.setImage(#imageLiteral(resourceName: "playerDown"), for: .normal)
